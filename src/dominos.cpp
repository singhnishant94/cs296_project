...
b2PolygonShape shape2;
      ...
      b2BodyDef bd3;
// bd3.linearVelocity.Set(5,0);
      bd3.position.Set(15.0f, 18.5f + 6*i);
      bd3.type = b2_dynamicBody;
